...
import * as Plugin_2 from '/Users/yangxiaoyu/全栈练习项目/lowcode-portal/src/.umi/plugin-access/rootContainer.ts';
...
import * as Plugin_6 from '../plugin-model/runtime';
  ...
  plugin.register({
    apply: Plugin_2,
    path: '/Users/yangxiaoyu/全栈练习项目/lowcode-portal/src/.umi/plugin-access/rootContainer.ts',
  });
  plugin.register({
    apply: Plugin_3,
