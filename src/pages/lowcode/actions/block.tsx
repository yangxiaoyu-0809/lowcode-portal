...
import {Dialog, Form, Input, Button, Select, Icon, Balloon, Message} from '@alifd/next';
...
const SaveAsBlock = (props: SaveAsBlockProps) => {
    ...
    const onVisibleChange = (visible:any,type:any) => {
    ...
    const save = async (values:any) => {
        ...
        const groupItem = groups.find(item => item.id === groupId) as any
