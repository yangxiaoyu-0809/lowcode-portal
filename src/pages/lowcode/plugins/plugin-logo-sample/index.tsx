...
import './index.scss';
import {getPageSchemaById} from "@/pages/lowcode/services/mockService";
...
const Logo: React.FC<IProps> = (props): React.ReactElement => {
  const { scenarioDisplayName, scenarioInfo, pageName } = props;
  ...
  return (
    <div className="lowcode-plugin-logo">
      ...
      <div className="scenario-name">{pageName}</div>
...
const LogoSamplePlugin = (ctx: IPublicModelPluginContext) => {
  return {
    async init() {
      ...
      const pageName = pageInfoObj.data.name
      ...
      skeleton.add({
        ...
        type: 'Widget',
        name: 'logo',
        content: <Logo scenarioDisplayName={scenarioDisplayName} scenarioInfo={scenarioInfo} pageName={pageName} />,
        contentProps: {
